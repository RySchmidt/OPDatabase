...
<td class="form"> <input type="number" name="chapter_number" required>  </td>
</tr>

<tr class="form">
<td class="form"> <label> Title: </label> </td>
<td class="form"> <input type="text" name="chapter_title" required>  </td>
</tr>

<tr class="form">
<td class="form"> <label> Publish Date: </label> </td>
<td class="form"> <input type="date" name="chapter_publish_date" required>  </td> 
</tr>
...
<tr class="form">
<td class="form"> <label name="hasCoverStory"> Has Cover Story: </label> </td>
<td class="from"> <input type="checkbox" name="hasCoverStory" value="Yes">  </td>
</tr>
